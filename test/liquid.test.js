...
describe('test/egg-view-liquid.test.js', () => {
    ...
    describe('render', () => {
        ...
        it('should render error', () => {
            return app.httpRequest()
                .get('/error')
                .expect('tag "{%a#####" not closed, file:/Users/georgetan/Documents/workspace/gitHub/egg-view-liquid/test/fixtures/apps/liquid-view/app/view/error.liquid, line:1, col:1')
                .expect(200);
        });
    });
